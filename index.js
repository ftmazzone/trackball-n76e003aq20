...
class Trackball extends EventEmitter {
    ...
    async turnOn(refreshRate = 50) {
        ...
        clearTimeout(this.readInputInterval);
        this.readInputInterval = setInterval(this.readInputs.bind(this), this.refreshRate);
    ...
    async writeByte(cmd, byte) {
        return await this.wire.writeByte(this.i2cAddress, cmd, byte);
    }
